...
export default function Header(classname: HeaderProps) {
  ...
  return (
    <header
      className={cn(
        `w-full border-b shadow-sm bg-white sticky top-0 z-50 transition-transform duration-500 ${hidden ? "-translate-y-full" : "translate-y-0"}`,
        classname,
      )}
    >
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <Popover>
          ...
          <PopoverContent className="w-64">
            {session ? (
              <div>
                <div className="border-b px-5 py-2 font-semibold">
                  {session.user?.name}
                </div>
                <div className="flex flex-col">
                  ...
                  <Button
                    onClick={() => signOut()}
                    variant={"outline"}
                    className="mt-4 text-left hover:bg-gray-100"
                  >
              ...
              <div>
                <div className="">
                  <Button
                    variant="outline"
                    className="w-full p-0 flex items-center justify-center hover:bg-gray-100"
                  >
                    <Link
